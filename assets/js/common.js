...
function each_page() {
    ...
    if ($("#index").length) {
        ...
        $(".common_list .list li .txt_block h2").each(function() {
            if ($(this).text().indexOf("TōFU") != -1) {
                $(this).addClass("f_hel_san");
            }
        });
        ...
        if ($(".common_detail .head .title").text().indexOf("TōFU") != -1) {
            $(".common_detail .head .title").addClass("f_hel_san");
        }
